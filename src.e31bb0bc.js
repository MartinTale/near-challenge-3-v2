...
var CONTRACT_NAME = "dev-1637344539916-84214556385408" || 'near-challenge-3.tale.testnet';
        ...
        switch (_context.prev = _context.next) {
          ...
          case 2:
            ...
            return new _nearApiJs.Contract(window.walletConnection.account(), nearConfig.contractName, {
              ...
              viewMethods: ['get_avatars'],
              // Change methods can modify the state. But you don't receive the returned value when called.
              changeMethods: ['set_avatar'],
...
var _getConfig = (0, _config.default)('development'),
...
document.getElementById('refresh-avatar').onclick = function (e) {
  e.preventDefault();
  currentAvatar = Date.now();
  avatarContainer.src = 'https://avatars.dicebear.com/api/bottts/' + currentAvatar + '.svg';
  document.getElementById('greeting').value = currentAvatar;
};
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.prev = 3;
            _context.next = 6;
            return window.contract.set_avatar({
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return contract.get_avatars();

          case 2:
            currentGreeting = _context2.sent;
            console.log(currentGreeting); // document.querySelectorAll('[data-behavior=greeting]').forEach(el => {
            //   // set divs, spans, etc
